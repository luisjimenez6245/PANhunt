...
def make_exe():
    ...
    #policy.resources_location = "filesystem-relative:py"
    ...
    #exe.add_python_resources(exe.pip_download(["altgraph", "colorama", "configparser", "macholib", "progressbar"]))
    ...
    exe.add_python_resources(exe.read_package_root(
        path="./",
        packages=["filehunt", "pst", "msmsg", "main"],
    ))
